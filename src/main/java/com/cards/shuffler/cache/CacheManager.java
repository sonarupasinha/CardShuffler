...
public class CacheManager {
	...
	private Map<String, Deck> cacheMap;
	 ...
	 */
	public void addToCache(String deckName, Deck deck) throws AppException {
		System.out.println("Adding to cache - Dack : " + deckName);
		try {
			cacheMap.put(deckName, deck);
		} catch (Exception e) {
	...
	public void removeFromCache(String deckName) throws AppException {
		Iterator<Entry<String, Deck>> cacheMapIterator = null;
		...
		while (cacheMapIterator.hasNext()) {
			Entry<String, Deck> entry = cacheMapIterator.next();
	 ...
	 * @throws AppException
	 */
	public Deck lookupCache(String deckName) throws AppException {
		Iterator<Entry<String, Deck>> cacheMapIterator = null;
		Deck deck = null;
		cacheMapIterator = cacheMap.entrySet().iterator();
	 ...
	 * 
	 * @return A collection of Deck type for all the decks in the cache
	 */
	public List<Deck> lookupCache() {
		Iterator<Entry<String, Deck>> cacheMapIterator = null;
